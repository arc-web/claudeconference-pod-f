...
This is a 5-hour hands-on session (1 PM to 6 PM). By 6 PM, the pod needs something they can demo. Done and working beats perfect and unfinished. Keep that urgency in mind.
...
- Hannah Athena Estrera (Pod Leader) - Has a Claude subscription, on Mac
- Rome Nicolas - Has a Claude subscription, on Mac
- Mark Jayson Agao - Has used AI coding tools before, on Windows
- Michael Ian Rule - New to AI tools, on Mac
- Earl Ceniza - New to AI tools, on Windows

Pod Leader: Hannah Athena Estrera - keeps the team moving, calls votes when stuck, makes sure everyone has something to do.
