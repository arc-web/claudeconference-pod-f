...
![](https://img.shields.io/badge/Pod_F-5_Members-F5A623?style=for-the-badge)
...
| | Name | Role | Computer |
|---|------|------|----------|
| 👑  **Hannah Athena Estrera** | Pod Leader | Mac |
|     **Rome Nicolas** | Member | Mac |
|     **Mark Jayson Agao** | Member | Windows |
|     **Michael Ian Rule** | Member | Mac |
|     **Earl Ceniza** | Member | Windows |

**Hannah Athena Estrera** is your pod leader - they keep things moving, call votes when the group is stuck, and make sure everyone has something to do. The leader can hand the role to someone else if they want to.
...
- **Discord - Pod F channel** - https://discord.gg/g2pJzjmV
